            ...
            <View style={styles.box_size}>
                  ...
                  <View style={styles.buttonrow}>
                    <View>
                      <Image
                        ...
                        source={require("../../screens/AppImage/HomeImage/AXISMUTUALFUND_MF.png")}
                      />
                    </View>
              ...
              <View style={[styles.row_return]}>
                <View style={styles.year_return}>
                  <View>
                    <Text style={[styles.return_text]}>SIP Amount</Text>
                  </View>
                  <View>
                    <Text style={[styles.return_per]}>1,000</Text>
                  </View>
                </View>

                <View style={styles.year_return}>
                  <View>
                    <Text style={[styles.return_text]}>Date</Text>
                  </View>
                  <View>
                    <Text style={[styles.return_per]}>09 August 2024</Text>
                  </View>
                </View>

                <View style={styles.year_return}>
                  <View>
                    <Text style={[styles.return_text]}>Status</Text>
                  </View>
                  <View>
                    <Text style={[styles.return_per]}>Accepted</Text>
                  </View>
                </View>
              </View>
            </View>
